...
document.getElementById('createGuildActionBtn').addEventListener('click', () => {
    ...
    .then(msg => {
        if (msg === 'SUCCESS') {
            ...
            checkMyGuildStatus(); // 내 정보 화면으로 전환
